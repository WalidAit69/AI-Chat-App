...
export interface Subscription {
  id?: string;
  /**
   * Set of key-value pairs that you can atach to an object.
...
canceled_at` will still reflect the date of the initial cancellation request, not the end of the subscription period when the subscript
